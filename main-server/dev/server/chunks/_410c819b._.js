...
"[project]/app/api/presentations/[id]/checkpoints/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request, { params }) {
    try {
        ...
        const { userId, pageNumber, question, options, correctAnswer, timeLimit } = body;
        // 1. Kiểm tra quyền sở hữu
        const presentation = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].presentation.findUnique({
            where: {
                id: presentationId
            }
        });
        ...
        const existingCheckpoint = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].presentationCheckpoint.findFirst({
            where: {
        ...
        if (existingCheckpoint) {
            // A. Nếu có rồi -> UPDATE
            result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].presentationCheckpoint.update({
                where: {
            ...
            result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].presentationCheckpoint.create({
                data: {
                    presentationId,
                    pageNumber,
                    question,
...
async function DELETE(request, { params }) {
    try {
        ...
        const checkpoint = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].presentationCheckpoint.findFirst({
            where: {
                presentationId,
        ...
        // Thực hiện xóa
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].presentationCheckpoint.delete({
            where: {
                id: checkpoint.id
            }
        });
...
//# sourceMappingURL=_410c819b._.js.map
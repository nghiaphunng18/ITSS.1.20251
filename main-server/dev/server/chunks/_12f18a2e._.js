...
"[project]/app/api/presentations/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        // 3. Create Record
        const newPresentation = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].presentation.create({
            data: {
                name,
                fileUrl,
                ownerId: userId
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(newPresentation, {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=_12f18a2e._.js.map
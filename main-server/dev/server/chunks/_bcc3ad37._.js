...
"[project]/app/api/classes/[id]/groups/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const groups = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].group.findMany({
            where: {
                classId
            },
            include: {
...
async function POST(request, { params }) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].group.deleteMany({
            where: {
                classId
            }
        });
        // Create new groups
        const createdGroups = await Promise.all(groups.map(async (group)=>{
            const newGroup = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].group.create({
                data: {
                    classId,
                    name: group.name,
                    createdById,
...
//# sourceMappingURL=_bcc3ad37._.js.map
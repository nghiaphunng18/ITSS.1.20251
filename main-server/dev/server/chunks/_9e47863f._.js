...
"[project]/app/api/presentations/teacher/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(_, { params }) {
    try {
        ...
        // 2. Query DB
        const presentations = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].presentation.findMany({
            where: {
                ownerId: userId
            },
            orderBy: {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(presentations);
    } catch (error) {
...
//# sourceMappingURL=_9e47863f._.js.map